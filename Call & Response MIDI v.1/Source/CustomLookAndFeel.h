...
public:
    ...
    // Colors
    static juce::Colour getDarkBg()        { return juce::Colour(0xff0d1117); }
    static juce::Colour getPanelBg()       { return juce::Colour(0xff161e2b); }
    static juce::Colour getCardBg()        { return juce::Colour(0xff1b2636); }
    static juce::Colour getLineBorder()    { return juce::Colour(0xff2d3c52); }
    static juce::Colour getNeonCyan()      { return juce::Colour(0xff00e5ff); }
    static juce::Colour getNeonOrange()    { return juce::Colour(0xffff9900); }
    static juce::Colour getNeonEmerald()   { return juce::Colour(0xff00ff88); }
    static juce::Colour getNeonViolet()    { return juce::Colour(0xffc084fc); }
    static juce::Colour getMutedText()     { return juce::Colour(0xff8a9eb8); }
    static juce::Colour getActiveText()    { return juce::Colour(0xfff0f6fc); }
};
